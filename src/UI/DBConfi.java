 ...
 * @author pc
 */
public class DBConfi extends javax.swing.JFrame {

    /**
     * Creates new form DBConfi
     */
    public DBConfi() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBConfi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
